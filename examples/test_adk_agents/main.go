...
func testADKAgent(agentType, agentID string, config *types.AgentConfig, task *types.Task, apiKey string, createAgent func(string, *types.AgentConfig, string) (interface{}, error)) {
...
func testEngineerAgent(apiKey string) {
	...
	testADKAgent("Engineer", "adk-engineer-1", config, task, apiKey, func(id string, cfg *types.AgentConfig, key string) (interface{}, error) {
...
func testManagerAgent(apiKey string) {
	...
	testADKAgent("Manager", "adk-manager-1", config, task, apiKey, func(id string, cfg *types.AgentConfig, key string) (interface{}, error) {
